...
function logIn(form) {
    ...
    for (var ad of adminInfo) {
        if (equalUser(newUser, ad)) {
            alert('Xin chào Sếp - Admin MuLDShop .. ');
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Trang chủ MuLDShop" title="MuLDShop - Thế giới Công Nghệ">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">MuLDShop Store</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">MuLD Group</span></p>
    </div>`);
}
	...
	<div class="containTaikhoan">
        ...
        <div class="taikhoan">
            ...
            <div class="tab-content">
                <div id="login">
                    <h1>Chào mừng bạn trở lại MuLDShop!</h1>
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0375655968" style="color: #288ad6;">0375655968</a>
                </li>
            </ul>
        </section>
    </div>`);
