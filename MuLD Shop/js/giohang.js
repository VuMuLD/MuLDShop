...
window.onload = function () {
	...
	var tags = ["Laptop", "iPhone", "Samsung", "Oppo", "Mobi" ,"PC" , "Laptop" , "Tainghe"];
...
function thanhToan() {
	...
	if (window.confirm('Thanh toán giỏ hàng ?')) {
		...
		capNhatMoiThu();
		addAlertBox('Các sản phẩm đã được gửi vào đơn hàng chờ Admin xử lý và Gọi trực tiếp hoặc Liên hệ qua Mail cho bạn để xác nhận  ', '#17c671', '#fff', 4000);
	}
}
